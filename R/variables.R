variables<-setRefClass("variables",
                  ...
                  methods = list(
                   ...
                   mcd43a4 = c(red='Nadir_Reflectance_Band1',nir='Nadir_Reflectance_Band2',blue='Nadir_Reflectance_Band3',green='Nadir_Reflectance_Band4',swir1='Nadir_Reflectance_Band5',swir2='Nadir_Reflectance_Band6',mwir='Nadir_Reflectance_Band7'),
                   "Sentinel-1" = c(""),
